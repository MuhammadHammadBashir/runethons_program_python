...
class ReportGenerator:
    ...
    def generate_prompt_paper(self):
        ...
        video_analysis_data = {
            ...
            "potentialIssues": self.videoAnalysis.get("potentialIssues"),
            "injuryRiskAssessment": self.videoAnalysis.get("injuryRiskAssessment"),
        }
    ...
    def generate_report(self,reportId):
